        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <Image src="/images/istarter-logo.png" alt="iStarter" width={150} height={40} className="h-8 w-auto" />
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <Card className="border-0 shadow-lg">
              <CardContent className="p-8 text-center">
                <div className="w-24 h-24 mx-auto mb-6">
                  <Image
                    src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Ritratti_Martino_1171%201%20%281%29.jpg-AAOvDrPMqOtZtsWKyyPT4aHYWkjMUk.jpeg"
                    alt="Martino Testa"
                    width={96}
                    height={96}
            ...
            <Card className="border-0 shadow-lg">
              <CardContent className="p-8 text-center">
                <div className="w-24 h-24 mx-auto mb-6">
                  <Image
                    src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Foto_Chiarello_2024.jpg-ZZ7iX7ArJGVkVzACMRxd0vBlq3PPUd.jpeg"
